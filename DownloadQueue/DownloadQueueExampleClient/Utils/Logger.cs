...
namespace DownloadQueueExampleClient.Utils
{
    ...
    //    private static System.Diagnostics.EventLog appLog = null;
    //    private static string logFilePath;
    //    private static long logFileThresholdMB = 5;
    ...
    //        appLog = new System.Diagnostics.EventLog();
    //        appLog.Source = "DownloadQueueExampleClient";

    //        //string logDirPath = ConfigurationManager.AppSettings["logdir"];
    //        //if (logDirPath == null)
    //        //    logDirPath = HttpContent.Current.Server.MapPath("~");
    //        logFilePath = Path.Combine("C:\\Temp\\", "log.txt");
